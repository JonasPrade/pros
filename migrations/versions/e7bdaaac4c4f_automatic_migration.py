...
Revision ID: e7bdaaac4c4f
Revises: 0b94fb2568a7
Create Date: 2022-07-14 18:27:15.087890
...
revision = 'e7bdaaac4c4f'
down_revision = '0b94fb2568a7'
branch_labels = None
depends_on = None
...
def upgrade_():
    ...
    op.drop_column('railway_lines', 'streckennummer')
...
def downgrade_():
    ...
    op.add_column('railway_lines', sa.Column('streckennummer', sa.INTEGER(), autoincrement=False, nullable=True))
