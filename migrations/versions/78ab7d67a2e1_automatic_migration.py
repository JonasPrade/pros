...
Revision ID: 78ab7d67a2e1
Revises: 8b3546a30099
Create Date: 2022-08-16 22:27:09.504154
...
revision = '78ab7d67a2e1'
down_revision = '8b3546a30099'
branch_labels = None
depends_on = None
...
def upgrade_():
    ...
    # op.add_column('projects_contents', sa.Column('station_railroad_switches', sa.Boolean(), nullable=False))
