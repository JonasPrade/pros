...
filepath = os.path.abspath("/Users/jonas/Library/CloudStorage/OneDrive-Persönlich/TU Berlin neu/Masterarbeit/Code/pros/example_data/railgraph/paths/LDBGtoLLWS.json")
print(filepath)
