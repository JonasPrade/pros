...
\begin{center}
\captionof{table}{\label{table_\VAR{scenario.id}_übersicht_untersuchungsgebiet_\VAR{scenario.id}} Übersicht ausgewählte Untersuchungsgebiete Szenrio \VAR{scenario.id}}
