\subsection{e-Fuel günstiger (1€/l) - Szenarionummer 21}\label{chap_kenngrößen_s_21}

\subsubsection{Kenngrößen Ausgangssituation}
\captionof{table}{\label{table_21_kenngrößen_ausgangsszenario_infrastrukturkilometer} Kenngrößen Ausgangszenario genutzte Infrastruktur jeweils für \acrshort{spnv}, \acrshort{spfv} und \acrshort{sgv} sowie insgesamt}
\begin{center}
...
\captionof{table}{\label{table_21_kenngrößen_ausgangsszenario_betriebskilometer} Kenngrößen Ausgangszenario Zugkilometer jeweils für \acrshort{spnv}, \acrshort{spfv} und \acrshort{sgv} sowie insgesamt}
\begin{center}
...
\captionof{table}{\label{table_21_kenngrößen_scenario} Basiskenngrößen Szenario 21}
\begin{center}
...
\captionof{table}{\label{table_21_kenngrößen_untersuchungsgebiete} Anzahl Untersuchungsgebiete sowie Kilometer nach Traktion Szenario 21}
\begin{center}
...
\captionof{table}{\label{table_21_kenngrößen_untersuchungsgebiete_no_optimised} Anzahl Untersuchungsgebiete sowie Kilometer nach Traktion (Optimierte Elektrifizierung aufgeteilt) Szenario 21}
\begin{center}
	\begin{tabularx}{\textwidth}{X | r | r | r} Traktion & Anzahl & Kilometer Infrastruktur & Zugkilometer (Tag) \\
	\hline
...
\captionof{table}{\label{table_21_kenngrößen_investition_cost_by_traction} Investitionsvolumen sowie Betriebskosten (Barwert Preisstand 2016) Szenario 21}
\begin{center}
...
\captionof{table}{\label{table_21_kenngrößen_sgv} Zugkilometer Güter-, Fern- und Nahverkehr Szenario 21 für Linien mit nicht elektrifizierten Abschnitten im Bezugsfall}
\begin{center}
